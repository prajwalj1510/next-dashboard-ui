...
import StudentAttendanceCart from '@/components/StudentAttendanceCart'
            ...
            <div className='w-full xl:w-2/3'>
                ...
                <div className='flex flex-col lg:flex-row gap-4'>
                    ...
                    <div className='bg-prajwalSky py-6 px-4 rounded-md flex-1 flex gap-4'>
                        <div className='w-1/3'>
                            <Image src={student.img || '/Avatar.png'} alt='' width={144} height={144} className='size-36 rounded-full object-cover' />
                        </div>
                    ...
                    <div className='flex-1 flex gap-4 justify-between flex-wrap'>
                        ...
                        <div className='bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]'>
                            ...
                            <Suspense fallback="loading...">
                                <StudentAttendanceCart id={student.id} />
                            </Suspense>
                        </div>
                        <div className='bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]'>
            ...
            <div className='w-full xl:w-1/3 flex flex-col gap-4'>
                <div className='bg-white p-4 rounded-md'>
                    ...
                    <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
                        <Link href={`/list/lessons?classId=${2}`} className='p-3 rounded-mg bg-prajwalSkyLight'>
                            Student's Lessons
                        </Link>
                        <Link href={`/list/teachers?classId=${2}`} className='p-3 rounded-mg bg-prajwalPurpleLight'>
                            Student's Teachers
                        </Link>
                        <Link href={`/list/exams?classId=${2}`} className='p-3 rounded-mg bg-prajwalSkyLight'>
                            Student's Exams
                        </Link>
                        <Link href={`/list/assignments?classId=${2}`} className='p-3 rounded-mg bg-prajwalPurpleLight'>
                            Student's Assignments
                        </Link>
                        <Link href={`/list/results?studentId=${"student2"}`} className='p-3 rounded-mg bg-prajwalYellowLight'>
                            Student's Results
                        </Link>
                    </div>
                </div>
