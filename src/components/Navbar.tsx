  ...
  return (
    <div className='flex items-center justify-between p-4'>
      ...
      <div className='flex items-center gap-6 justify-end w-full'>
        <div className='bg-blue-50 rounded-full size-7 flex items-center justify-center cursor-pointer'>
          <Image src='/message.png' alt='' width={20} height={20} />
        </div>
        <div className='bg-blue-50 rounded-full size-7 flex items-center justify-center cursor-pointer relative'>
        ...
        <div className='flex flex-col'>
          <span className='text-xs leading-3 font-medium'>Prajwal</span>
